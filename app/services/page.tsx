export default function ServicesPage() {
  return (
    <>
      ...
      {/* Services Grid – from your HTML */}
      <section className="px-margin-edge pb-section-gap max-w-screen-2xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-32 gap-x-12">
          {/* Residential Development */}
          <div className="group cursor-default">
            <div className="aspect-[16/10] overflow-hidden bg-neutral-100 mb-8">
              <img
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 flex items-center gap-2 text-primary font-label-caps text-[10px] tracking-widest uppercase group-hover:gap-4 transition-all duration-300">
                View Portfolio
      ...
      {/* Tonal Layer Detail – from your HTML */}
      <section className="bg-surface-container-low py-section-gap px-margin-edge text-center">
